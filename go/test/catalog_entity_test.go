...
func TestCatalogEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set COLORADOINFORMATIONMARKETPLACE_TEST_CATALOG_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func catalogBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("COLORADOINFORMATIONMARKETPLACE_TEST_CATALOG_ENTID")
	...
	return &entityTestSetup{
		...
		idmap:         idmapResolved,
		env:           env,
		explain:       env["COLORADOINFORMATIONMARKETPLACE_TEST_EXPLAIN"] == "TRUE",
		live:          live,
