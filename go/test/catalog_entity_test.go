...
func catalogBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("COLORADO_INFORMATION_MARKETPLACE_TEST_CATALOG_ENTID")
	...
	idmapResolved := core.ToMapAny(env["COLORADO_INFORMATION_MARKETPLACE_TEST_CATALOG_ENTID"])
	if idmapResolved == nil {
		idmapResolved = core.ToMapAny(idmap)
	}

	if env["COLORADO_INFORMATION_MARKETPLACE_TEST_LIVE"] == "TRUE" {
		mergedOpts := vs.Merge([]any{
			map[string]any{
			},
			extra,
		})
		client = sdk.NewColoradoInformationMarketplaceSDK(core.ToMapAny(mergedOpts))
	}
	...
	return &entityTestSetup{
		...
		idmap:         idmapResolved,
		env:           env,
		explain:       env["COLORADO_INFORMATION_MARKETPLACE_TEST_EXPLAIN"] == "TRUE",
		live:          live,
