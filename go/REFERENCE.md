# ColoradoInformationMarketplace Golang SDK Reference

Complete API reference for the ColoradoInformationMarketplace Golang SDK.
...
#### `Test() *ColoradoInformationMarketplaceSDK`
...
#### `TestSDK(testopts, sdkopts map[string]any) *ColoradoInformationMarketplaceSDK`
...
#### `Catalog(data map[string]any) ColoradoInformationMarketplaceEntity`
