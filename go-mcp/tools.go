...
func registerTools(server *mcp.Server, client *sdk.ColoradoInformationMarketplaceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "colorado-information-marketplace_list",
		Description: "List records from ColoradoInformationMarketplace. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "colorado-information-marketplace_load",
		Description: "Load a single record from ColoradoInformationMarketplace. " +
...
func runOp(client *sdk.ColoradoInformationMarketplaceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ColoradoInformationMarketplaceSDK, name string) (sdk.ColoradoInformationMarketplaceEntity, error) {
