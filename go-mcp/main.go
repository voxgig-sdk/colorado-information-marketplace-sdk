// Command ColoradoInformationMarketplace-mcp is an MCP server exposing the ColoradoInformationMarketplace
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ColoradoInformationMarketplace_list  — list records of an entity
//	ColoradoInformationMarketplace_load  — load a single record of an entity
//
