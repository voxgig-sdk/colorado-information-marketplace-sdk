...
|---|---|---|
| `ts/` | @voxgig-sdk/colorado-information-marketplace-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/colorado-information-marketplace-sdk \
      --repository voxgig-sdk/colorado-information-marketplace-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/colorado-information-marketplace-sdk` shows it, and
`npm trust revoke @voxgig-sdk/colorado-information-marketplace-sdk --id=<id>` removes it.
