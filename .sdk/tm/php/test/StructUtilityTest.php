...
// ColoradoInformationMarketplace SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ColoradoInformationMarketplaceOmni::makeStructRunner(
    ...
    {
        return ColoradoInformationMarketplaceOmni::objmodel(ColoradoInformationMarketplaceOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return ColoradoInformationMarketplaceOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return ColoradoInformationMarketplaceOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ColoradoInformationMarketplaceOmni::structfix($now, Struct::undef()))
                        !== json_encode(ColoradoInformationMarketplaceOmni::structfix($val, Struct::undef()))) {
