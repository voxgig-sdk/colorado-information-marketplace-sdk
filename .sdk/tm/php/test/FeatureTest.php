...
// ColoradoInformationMarketplace SDK feature test
//
...
class FtCtrl extends ColoradoInformationMarketplaceControl
{
...
class FtClient
{
    ...
    private ColoradoInformationMarketplaceUtility $utility;

    public function __construct(ColoradoInformationMarketplaceUtility $utility, array $options)
    {
    ...
    public function get_utility(): ColoradoInformationMarketplaceUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (ColoradoInformationMarketplaceContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public ColoradoInformationMarketplaceContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (ColoradoInformationMarketplaceContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = ColoradoInformationMarketplaceConfig::make_feature($name);
    ...
    private static function buildUrl(ColoradoInformationMarketplaceSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof ColoradoInformationMarketplaceError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new ColoradoInformationMarketplaceResponse($fetched);
        }
    ...
    private function fail(ColoradoInformationMarketplaceContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (ColoradoInformationMarketplaceContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
