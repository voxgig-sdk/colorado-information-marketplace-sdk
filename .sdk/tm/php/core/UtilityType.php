...
// ColoradoInformationMarketplace SDK utility type

class ColoradoInformationMarketplaceUtility
{
    ...
    public static function copy(ColoradoInformationMarketplaceUtility $src): ColoradoInformationMarketplaceUtility
    {
        $u = new ColoradoInformationMarketplaceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
