...
// ColoradoInformationMarketplace SDK rbac feature
...
class ColoradoInformationMarketplaceRbacFeature extends ColoradoInformationMarketplaceBaseFeature
{
    ...
    private function _required(ColoradoInformationMarketplaceContext $ctx): ?string
    {
    ...
    private function _reject(ColoradoInformationMarketplaceContext $ctx, string $required): void
    {
    ...
    private function _track(ColoradoInformationMarketplaceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
