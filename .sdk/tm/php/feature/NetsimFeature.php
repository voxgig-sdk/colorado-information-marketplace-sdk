...
// ColoradoInformationMarketplace SDK netsim feature
...
class ColoradoInformationMarketplaceNetsimFeature extends ColoradoInformationMarketplaceBaseFeature
{
    ...
    private function _simulate(ColoradoInformationMarketplaceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ColoradoInformationMarketplaceContext $ctx, array $applied): void
    {
        $client = $this->client;
