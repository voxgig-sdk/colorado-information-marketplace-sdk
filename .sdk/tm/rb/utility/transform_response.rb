# ColoradoInformationMarketplace SDK utility: transform_response
...
module ColoradoInformationMarketplaceUtilities
  TransformResponse = ->(ctx) {
    ...
    transform = ColoradoInformationMarketplaceHelpers.to_map(VoxgigStruct.getprop(point, "transform"))
