...
class ColoradoInformationMarketplaceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ColoradoInformationMarketplaceTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ColoradoInformationMarketplaceTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ColoradoInformationMarketplaceTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
