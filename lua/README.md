# ColoradoInformationMarketplace Lua SDK



The Lua SDK for the ColoradoInformationMarketplace API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/colorado-information-marketplace-sdk/releases)),
...
| `tags` | `table` | Tags associated with the dataset |
...
```
lua/
├── colorado-information-marketplace_sdk.lua    -- Main SDK module
...
The main module (`colorado-information-marketplace_sdk`) exports the SDK constructor
