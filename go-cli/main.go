// Command ColoradoInformationMarketplace-cli is a CLI + REPL for the ColoradoInformationMarketplace SDK,
...
const prompt = "colorado-information-marketplace"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      COLORADO_INFORMATION_MARKETPLACE_APIKEY (api key), COLORADO_INFORMATION_MARKETPLACE_BASE (base url override)")
