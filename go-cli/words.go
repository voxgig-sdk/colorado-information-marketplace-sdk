...
func registerSDKWords(r *eng.Registry, client *sdk.ColoradoInformationMarketplaceSDK) {
...
func runOp(client *sdk.ColoradoInformationMarketplaceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
