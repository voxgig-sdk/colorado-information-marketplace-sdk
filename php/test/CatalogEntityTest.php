...
class CatalogEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = ColoradoInformationMarketplaceSDK::test($seed, null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set COLORADO_INFORMATION_MARKETPLACE_TEST_CATALOG_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function catalog_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("COLORADO_INFORMATION_MARKETPLACE_TEST_CATALOG_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["COLORADO_INFORMATION_MARKETPLACE_TEST_CATALOG_ENTID"]);
    ...
    if ($env["COLORADO_INFORMATION_MARKETPLACE_TEST_LIVE"] === "TRUE") {
        ...
        $client = new ColoradoInformationMarketplaceSDK(Helpers::to_map($merged_opts));
    }
