...
class CatalogEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set COLORADOINFORMATIONMARKETPLACE_TEST_CATALOG_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function catalog_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("COLORADOINFORMATIONMARKETPLACE_TEST_CATALOG_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["COLORADOINFORMATIONMARKETPLACE_TEST_CATALOG_ENTID"]);
