...
// ColoradoInformationMarketplace SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ColoradoInformationMarketplaceSDK::test)
...
{
    private const SDK_CLASS = 'ColoradoInformationMarketplaceSDK';
    ...
    private const SDK_BASE = 'coloradoinformationmarketplace_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../coloradoinformationmarketplace_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
