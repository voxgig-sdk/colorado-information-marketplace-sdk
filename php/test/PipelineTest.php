...
// ColoradoInformationMarketplace SDK pipeline test
//
...
{
    private static function utility(): ColoradoInformationMarketplaceUtility
    {
        return new ColoradoInformationMarketplaceUtility();
    }
    ...
    private static function ctx(array $over = []): ColoradoInformationMarketplaceContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ColoradoInformationMarketplaceContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ColoradoInformationMarketplaceOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ColoradoInformationMarketplaceError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ColoradoInformationMarketplaceOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ColoradoInformationMarketplaceMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ColoradoInformationMarketplaceOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ColoradoInformationMarketplaceMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ColoradoInformationMarketplaceOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ColoradoInformationMarketplaceMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ColoradoInformationMarketplaceSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ColoradoInformationMarketplaceMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ColoradoInformationMarketplaceResponse([]),
            'result' => new ColoradoInformationMarketplaceResult([]),
        ]);
        [, $err] = ColoradoInformationMarketplaceMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ColoradoInformationMarketplaceSpec([]),
            'response' => null,
            'result' => new ColoradoInformationMarketplaceResult([]),
        ]);
        [, $err] = ColoradoInformationMarketplaceMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ColoradoInformationMarketplaceSpec(['step' => 's']),
            'response' => new ColoradoInformationMarketplaceResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ColoradoInformationMarketplaceResult([]),
        ]);
        [, $err] = ColoradoInformationMarketplaceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ColoradoInformationMarketplaceSpec(['step' => 's']),
            'response' => new ColoradoInformationMarketplaceResponse(self::resp(200, ['v' => 1])),
            'result' => new ColoradoInformationMarketplaceResult([]),
        ]);
        [, $err] = ColoradoInformationMarketplaceMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ColoradoInformationMarketplaceSpec(['step' => 's']),
            'response' => new ColoradoInformationMarketplaceResponse(self::resp(200, ['v' => 2])),
            'result' => new ColoradoInformationMarketplaceResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ColoradoInformationMarketplaceMakeResponse::call($ctx);
    ...
    {
        $preset = new ColoradoInformationMarketplaceResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ColoradoInformationMarketplaceSpec([]),
            'response' => new ColoradoInformationMarketplaceResponse([]),
            'result' => new ColoradoInformationMarketplaceResult([]),
        ...
        [$got, $err] = ColoradoInformationMarketplaceMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ColoradoInformationMarketplaceResult([])]);
        [, $err] = ColoradoInformationMarketplaceMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ColoradoInformationMarketplaceSpec([]), 'result' => null]);
        [, $err] = ColoradoInformationMarketplaceMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ColoradoInformationMarketplaceSpec(['step' => 's']),
            'result' => new ColoradoInformationMarketplaceResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ColoradoInformationMarketplaceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ColoradoInformationMarketplaceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ColoradoInformationMarketplaceSpec(['step' => 's']),
            'result' => new ColoradoInformationMarketplaceResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ColoradoInformationMarketplaceOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ColoradoInformationMarketplaceMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ColoradoInformationMarketplaceResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ColoradoInformationMarketplaceSpec([]),
            'result' => new ColoradoInformationMarketplaceResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ColoradoInformationMarketplaceMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ColoradoInformationMarketplaceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ColoradoInformationMarketplaceError('boom', 'boom');
        $utility->fetcher = function (ColoradoInformationMarketplaceContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ColoradoInformationMarketplaceSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ColoradoInformationMarketplaceMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ColoradoInformationMarketplaceContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ColoradoInformationMarketplaceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ColoradoInformationMarketplaceResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ColoradoInformationMarketplaceMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ColoradoInformationMarketplaceContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ColoradoInformationMarketplaceSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ColoradoInformationMarketplaceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ColoradoInformationMarketplaceResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ColoradoInformationMarketplaceSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ColoradoInformationMarketplaceMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ColoradoInformationMarketplaceMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ColoradoInformationMarketplaceMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ColoradoInformationMarketplaceResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ColoradoInformationMarketplaceDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ColoradoInformationMarketplaceResult(['ok' => false])]);
        $this->expectException(ColoradoInformationMarketplaceError::class);
        ColoradoInformationMarketplaceDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ColoradoInformationMarketplaceResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ColoradoInformationMarketplaceMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ColoradoInformationMarketplaceMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ColoradoInformationMarketplaceBaseFeature();
        $b = new ColoradoInformationMarketplaceBaseFeature();
        ColoradoInformationMarketplaceFeatureAdd::call($ctx, $a);
        ColoradoInformationMarketplaceFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ColoradoInformationMarketplaceBaseFeature
    {
        $f = new ColoradoInformationMarketplaceBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ColoradoInformationMarketplaceFeatureAdd::call($ctx, self::named_feature('a'));
        ColoradoInformationMarketplaceFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        ColoradoInformationMarketplaceFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        ColoradoInformationMarketplaceFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        ColoradoInformationMarketplaceFeatureAdd::call($ctx, $replace);
        ...
        ColoradoInformationMarketplaceFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ColoradoInformationMarketplaceContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ColoradoInformationMarketplaceSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ColoradoInformationMarketplacePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ColoradoInformationMarketplacePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ColoradoInformationMarketplaceResponse(['headers' => null]),
            'result' => new ColoradoInformationMarketplaceResult([]),
        ]);
        ColoradoInformationMarketplaceResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ColoradoInformationMarketplaceResultBody::call($ctx);
