...
// ColoradoInformationMarketplace SDK cache feature
...
class ColoradoInformationMarketplaceCacheFeature extends ColoradoInformationMarketplaceBaseFeature
{
    ...
    private function _through(ColoradoInformationMarketplaceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
