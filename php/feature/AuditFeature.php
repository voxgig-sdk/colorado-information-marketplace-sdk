...
// ColoradoInformationMarketplace SDK audit feature
...
class ColoradoInformationMarketplaceAuditFeature extends ColoradoInformationMarketplaceBaseFeature
{
    ...
    private function _emit(ColoradoInformationMarketplaceContext $ctx, string $outcome): void
    {
