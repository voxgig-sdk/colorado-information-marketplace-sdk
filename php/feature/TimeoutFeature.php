...
// ColoradoInformationMarketplace SDK timeout feature
...
class ColoradoInformationMarketplaceTimeoutFeature extends ColoradoInformationMarketplaceBaseFeature
{
    ...
    private function _with_timeout(ColoradoInformationMarketplaceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ColoradoInformationMarketplaceContext $_ctx, float $ms): void
    {
        $client = $this->client;
