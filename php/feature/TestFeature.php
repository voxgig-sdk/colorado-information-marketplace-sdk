...
// ColoradoInformationMarketplace SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ColoradoInformationMarketplaceTestFeature extends ColoradoInformationMarketplaceBaseFeature
{
    ...
    public function init(ColoradoInformationMarketplaceContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ColoradoInformationMarketplaceContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ColoradoInformationMarketplaceParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ColoradoInformationMarketplaceContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ColoradoInformationMarketplaceContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = ColoradoInformationMarketplaceParam::call($ctx, $k);
