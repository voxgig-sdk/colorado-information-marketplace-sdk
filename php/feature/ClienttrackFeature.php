...
// ColoradoInformationMarketplace SDK clienttrack feature
...
class ColoradoInformationMarketplaceClienttrackFeature extends ColoradoInformationMarketplaceBaseFeature
{
    ...
    public function PostConstruct(ColoradoInformationMarketplaceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ColoradoInformationMarketplace-SDK';
