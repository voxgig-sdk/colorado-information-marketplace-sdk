...
// ColoradoInformationMarketplace SDK proxy feature
...
class ColoradoInformationMarketplaceProxyFeature extends ColoradoInformationMarketplaceBaseFeature
{
    ...
    public function init(ColoradoInformationMarketplaceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ColoradoInformationMarketplaceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
