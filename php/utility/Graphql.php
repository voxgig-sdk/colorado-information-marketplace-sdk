...
// ColoradoInformationMarketplace SDK utility: graphql
//
...
class ColoradoInformationMarketplaceGraphql
{
    ...
    // equivalent.
    public static function body(ColoradoInformationMarketplaceContext $ctx): mixed
    {
    ...
    public static function errors(ColoradoInformationMarketplaceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
