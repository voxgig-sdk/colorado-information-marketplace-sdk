...
// ColoradoInformationMarketplace SDK utility: fetcher

class ColoradoInformationMarketplaceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ColoradoInformationMarketplaceSDK/1.0)';
    ...
    public static function call(ColoradoInformationMarketplaceContext $ctx, string $fullurl, array $fetchdef): array
    {
