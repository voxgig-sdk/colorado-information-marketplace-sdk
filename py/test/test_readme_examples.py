# ColoradoInformationMarketplace SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ColoradoInformationMarketplaceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ColoradoInformationMarketplaceSDK(...) and ColoradoInformationMarketplaceSDK.test(...) become
#      ColoradoInformationMarketplaceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "coloradoinformationmarketplace_sdk"
_SDK_CLASS = "ColoradoInformationMarketplaceSDK"
