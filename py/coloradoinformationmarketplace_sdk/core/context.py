...
from coloradoinformationmarketplace_sdk.core.helpers import get_ctx_prop, to_map
...
class ColoradoInformationMarketplaceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ColoradoInformationMarketplaceControl()
        ...
        if isinstance(sp, ColoradoInformationMarketplaceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ColoradoInformationMarketplaceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ColoradoInformationMarketplaceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ColoradoInformationMarketplaceOperation({})
    ...
    def make_error(self, code, msg):
        return ColoradoInformationMarketplaceError(code, msg, self)
