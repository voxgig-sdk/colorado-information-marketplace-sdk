...
from coloradoinformationmarketplace_sdk.utility import register

# Load features
from coloradoinformationmarketplace_sdk.feature.base_feature import ColoradoInformationMarketplaceBaseFeature
from coloradoinformationmarketplace_sdk.features import _has_feature, _make_feature
...
class ColoradoInformationMarketplaceSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ColoradoInformationMarketplaceUtility()
        self._utility = utility

        from coloradoinformationmarketplace_sdk.config import shared_config
    ...
    def get_utility(self):
        return ColoradoInformationMarketplaceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ColoradoInformationMarketplaceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Catalog(self, data=None) -> "CatalogEntity":
        ...
        from coloradoinformationmarketplace_sdk.entity.catalog_entity import CatalogEntity
        return CatalogEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ColoradoInformationMarketplaceSDK":
        if sdkopts is None:
            sdkopts = {}
