...
| `tester(testopts?, sdkopts?)` | `ColoradoInformationMarketplaceSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ColoradoInformationMarketplaceSDK.test(testopts?, sdkopts?)` | `ColoradoInformationMarketplaceSDK` | Create a test-mode client. |
...
| `client` | `client(): ColoradoInformationMarketplaceSDK` | Return the parent SDK client. |
...
├── src/
│   ├── ColoradoInformationMarketplaceSDK.ts        # Main SDK class
