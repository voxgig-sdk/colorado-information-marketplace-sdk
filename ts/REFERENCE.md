# ColoradoInformationMarketplace TypeScript SDK Reference

Complete API reference for the ColoradoInformationMarketplace TypeScript SDK.
...
```ts
new ColoradoInformationMarketplaceSDK(options?: object)
```
...
#### `ColoradoInformationMarketplaceSDK.test(testopts?, sdkopts?)`
...
**Returns:** `ColoradoInformationMarketplaceSDK` instance in test mode.
...
Alias for `ColoradoInformationMarketplaceSDK.test()`.
...
| `tags` | `any[]` | No | Tags associated with the dataset |
...
Return the parent `ColoradoInformationMarketplaceSDK` instance.
