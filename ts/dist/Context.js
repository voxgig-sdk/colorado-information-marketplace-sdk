...
const ColoradoInformationMarketplaceError_1 = require("./ColoradoInformationMarketplaceError");
...
class Context {
    ...
    error(code, msg) {
        return new ColoradoInformationMarketplaceError_1.ColoradoInformationMarketplaceError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
