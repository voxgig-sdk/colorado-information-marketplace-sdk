# ColoradoInformationMarketplace SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # ColoradoInformationMarketplaceSDK.new, not ColoradoInformationMarketplaceSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    ColoradoInformationMarketplaceSDK.new(opts)
  end
