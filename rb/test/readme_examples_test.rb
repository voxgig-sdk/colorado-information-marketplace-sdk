# ColoradoInformationMarketplace SDK — README + REFERENCE example snippet tests.
#
...
#      (ColoradoInformationMarketplaceSDK.test) seeded with an in-memory fixture for every
