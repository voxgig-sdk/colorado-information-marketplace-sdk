...
#      offline in seeded test mode (ColoradoInformationMarketplaceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ColoradoInformationMarketplace_sdk.rb")
  SDK_CLASS = "ColoradoInformationMarketplaceSDK"
  ...
  SDK_BASE = "ColoradoInformationMarketplace_sdk"
