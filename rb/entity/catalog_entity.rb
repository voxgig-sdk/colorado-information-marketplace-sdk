# ColoradoInformationMarketplace SDK Catalog entity
...
class CatalogEntity
  ...
  def data_set(args)
    if args
      @_data = ColoradoInformationMarketplaceHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = ColoradoInformationMarketplaceHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Catalog>, Array] the matching Catalog items; raises ColoradoInformationMarketplaceError on failure
