...
The Ruby SDK for the ColoradoInformationMarketplace API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.ColoradoInformationMarketplace(nil).load(
  { "id" => "test01" }, nil
)
