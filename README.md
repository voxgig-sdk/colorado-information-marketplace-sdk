...
Explore a wide range of public datasets and resources from the Colorado Information Marketplace, including information on government revenue and expenditures, transportation, demographics, business, and more.

Learn more about Colorado Information Marketplace at [data.colorado.gov](https://data.colorado.gov).
...
| Go CLI | `github.com/voxgig-sdk/colorado-information-marketplace-sdk/go-cli` | `go install github.com/voxgig-sdk/colorado-information-marketplace-sdk/go-cli/cmd/colorado-information-marketplace@latest` |
| Go MCP server | `github.com/voxgig-sdk/colorado-information-marketplace-sdk/go-mcp` | `go get github.com/voxgig-sdk/colorado-information-marketplace-sdk/go-mcp@latest` |
